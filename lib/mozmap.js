...
let utils = require('./utils'),
    ...
    http = require('http'),
    MozilliansData = require('./mozillians-processor'),
    location_data = require('./locations-processor'),
    app = express(),
    ...
    // DATA_PATH_PRIVATE = './static/mozillians-private.json',
...
function updateCache() {
    ...
    (new MozilliansData())
        ...
        .then(json => {
            ...
            // TODO this could be served for logged in Mozillians one day
            // utils.saveJsonFileSync(DATA_PATH_PRIVATE, json.Mozillians);
